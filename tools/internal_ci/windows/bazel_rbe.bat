...
call bazel_rbe/bazel_wrapper.bat --bazelrc=tools/remote_build/windows.bazelrc --output_user_root=T:\_bazel_output test --runs_per_test=30 %BAZEL_FLAGS% -- //test/core/end2end/... || exit /b 1
