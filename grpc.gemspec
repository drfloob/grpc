...
Gem::Specification.new do |s|
  ...
  s.files += %w( include/grpc/event_engine/internal/debug_shared_ptr.cc )
  s.files += %w( include/grpc/event_engine/internal/debug_shared_ptr.h )
  ...
  s.files += %w( test/core/util/stack_tracer.cc )
  s.files += %w( test/core/util/stack_tracer.h )
